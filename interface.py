...
def main():
    ...
    l5.place(relx= 0.08, rely=0.21)
    l6= tk.Label(root, text= "Choisis deux valeurs entre 0 et 99",font=("Courier New", 11),  justify='center', background=couleur)
    l6.place(relx= 0.05, rely=0.25)
